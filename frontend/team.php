                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="../images/group1.jpg" style="width: 80px; height: 80px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Gordon Ramsay</h5>
                    ...
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="../images/group2.jpg" style="width: 80px; height: 80px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Anne-Sophie Pic</h5>
                                <small>Master Chef</small>
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="../images/group3.jpg" style="width: 80px; height: 80px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Guy Fieri</h5>
                    ...
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="../images/group4.jpg" style="width: 80px; height: 80px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Bobby Flay</h5>
                                <small>Senior Chef</small>
                            </div>
                        </div>
                    </div>
