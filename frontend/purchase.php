...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    if(isset($_POST['purchase']))
    {
        ...
        $query1 = "INSERT INTO `order_manager`(`oder_id`,`username`,`cus_name`, `cus_email`, `cus_add1`, `cus_city`, `cus_phone`, `payment_status`, `order_date`,`total_amount`,`transaction_id`,`order_status`) VALUES ('$_POST[username]','$_POST[cus_name]','$_POST[cus_email]','$_POST[cus_add1]','$_POST[cus_city]','$_POST[cus_phone]','$_POST[payment_status]','$order_date','$_POST[amount]','$_POST[tran_id]','Pending')";
