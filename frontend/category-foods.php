...
<!-- Section for displaying food items based on the selected category -->
<div class="container">
    <div class="row">
        <div class="col-lg-3">
            <?php
    ...
    <div class="row">
        <?php
        // SQL query to get food items in the selected category
        $sql2 = "SELECT * FROM tbl_food WHERE category_id=$category_id";
        $res2 = mysqli_query($conn, $sql2);
        $count2 = mysqli_num_rows($res2);

        // Check if there are food items available in this category
        if($count2 > 0) {
            // Loop through each food item and display
