...
<head>
	...
	<title>Gallery Cafe Admin</title>
</head>
<body>
	...
	<section id="sidebar">
		<a href="index.php" class="brand">
			<img src="../images/Gallery Cafe1.png" width="80px" alt="">
		</a>
		<ul class="side-menu top">
			...
			<li class="active">
				<a href="manage-ei-order.php">
					...
					<span class="text" >Physical Orders&nbsp;&nbsp;&nbsp;
	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					<h1>Update Physical Orders</h1>
					<ul class="breadcrumb">
						<li><i class='bx bx-chevron-right' ></i></li>
						<li>
							<a class="active" href="manage-ei-order.php">Physical Orders</a>
						</li>
					</ul>
				</div>
</div>
